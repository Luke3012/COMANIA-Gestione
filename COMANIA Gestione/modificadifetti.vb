...
Public Class modificadifetti
    ...
    Private Sub ModLavori_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        lines = File.ReadAllLines(dir & "\persons\difects.txt")
        ListBox1.Items.AddRange(lines)
    End Sub

    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Utente.ComboBox2.Items.Clear()
        lines = File.ReadAllLines(dir & "\persons\difects.txt")
        Utente.ComboBox2.Items.AddRange(lines)
        Close()
    End Sub
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        Dim writelavoro As New StreamWriter(dir & "\persons\difects.txt", True)
    ...
    Private Sub delete_Click(sender As Object, e As EventArgs) Handles delete.Click
        ...
        Input = File.OpenText(dir & "\persons\difects.txt")
        While Input.Peek <> -1
            line = Input.ReadLine
        ...
        End While
        Input.Close()
        If File.Exists(dir & "\persons\difects.txt") Then
            File.Delete(dir & "\persons\difects.txt")
        End If
        Dim objWriter As New System.IO.StreamWriter(dir & "\persons\difects.txt", True)
    ...
    Private Sub cmdUp_Click(sender As Object, e As EventArgs) Handles cmdUp.Click
        ...
        Dim i As Integer
        W = New IO.StreamWriter(dir & "\persons\difects.txt")
